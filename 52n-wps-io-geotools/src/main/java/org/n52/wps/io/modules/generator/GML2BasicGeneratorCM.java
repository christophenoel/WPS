...
public class GML2BasicGeneratorCM extends ClassKnowingModule{
    ...
    public String getClassName() {
        return GML2BasicGenerator.class.getName();
    }
